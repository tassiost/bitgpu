// Quick WebGPU feature detection script
...
const server = createServer((req, res) => {
  ...
  if (path === '/') path = '/examples/test-features.html'
...
server.listen(8889, async () => {
  ...
  await page.goto('http://localhost:8889/examples/test-features.html', { waitUntil: 'networkidle0' })
