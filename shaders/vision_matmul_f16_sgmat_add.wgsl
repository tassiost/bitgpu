// SubgroupMatrix F16 matmul for vision tower:
...
@group(0) @binding(4) var<storage, read> residual: array<f32>;  // [M, N]
...
fn main(@builtin(workgroup_id) wg: vec3<u32>,
  ...
  for (var ks = 0u; ks < Ksteps; ks = ks + 1u) {
    ...
    // Cooperative load B tile [WG_N, TILE_K] as f16 (direct copy)
